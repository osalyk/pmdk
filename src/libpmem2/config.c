...
#define PMEM2_PROT_READ_WRITE (PMEM2_PROT_READ | PMEM2_PROT_WRITE)
#define PMEM2_PROT_READ_EXEC (PMEM2_PROT_READ | PMEM2_PROT_EXEC)
#define PMEM2_PROT_ALL (PMEM2_PROT_READ | PMEM2_PROT_WRITE |\
			PMEM2_PROT_EXEC)

/* pmem2_config_set_protection -- set flags */
int
