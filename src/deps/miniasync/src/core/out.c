	...
	int minor_version)
{
	...
	/*
	 * XXX SRCVERSION variable is currently removed from here since
	 * it didn't work. It should be added again along with logging.
	 * This variable comes from srcversion.h header, which is also not
	 * included in the miniasync repository yet.
	 */
