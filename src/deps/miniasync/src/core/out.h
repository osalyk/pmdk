...
#ifndef MINIASYNC_OUT_H
#define MINIASYNC_OUT_H 1
...
extern "C" {
	...
	/*
	 * Suppress errors which are after appropriate ASSERT* macro
	 * for nondebug builds.
	 */
...
#define OUT_FATAL_ABORT out_fatal
	...
	static __attribute__((always_inline)) inline void
		out_log_discard(const char *file, int line, const char *func,
	...
	static __attribute__((always_inline))
		OUT_FATAL_DISCARD_NORETURN inline void
			out_fatal_discard(const char *file, int line,
...
#define ERR(...)\
	...
	void out_set_vsnprintf_func(int (*vsnprintf_func)(char *str,
